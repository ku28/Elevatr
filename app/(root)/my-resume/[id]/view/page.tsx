...
export async function generateMetadata({ params, }: { params: { id: string };}): Promise<Metadata> {
  ...
  if (resume?.firstName === undefined && resume?.lastName === undefined) {
    return {
      title: "Elevatr - Professional AI Resume Builder",
      description:
  ...
  return {
    ...
    ${resume?.lastName}${resume?.lastName && " "}- Elevatr`,
    description: `${resume?.firstName} ${resume?.lastName}'s Resume. Powered by Elevatr.`,
  };
}
